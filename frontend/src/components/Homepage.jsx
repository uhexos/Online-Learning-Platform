      ...
      <div>
        ...
        <div className="container-fluid" style={cont1}>
          <div className="col-md-6">
            <p style={{ color: "#fff", fontSize: "50px", paddingTop: "50px" }}>
              Your course to prepare for university.
            </p>
...
const cont1 = {
  ...
  backgroundImage:
    "linear-gradient(to bottom, rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url('../imgs/auth_bg.jpg')",
