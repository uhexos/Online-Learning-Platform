...
export class CoursePaginator extends Component {
  ...
  componentWillReceiveProps(props) {
    this.setState({
      url: props.next_page ? props.next_page : props.previous_page
    });
  }
    ...
    fetch(`${url}`, {
      ...
      .then(
        result => {
          ...
          this.props.updateItems("current", result.current);
    ...
    return (
      <Pagination aria-label="Page navigation example">
        ...
        {this.props.previous_page ? (
          ...
          <PaginationItem key="previous">
            <PaginationLink previous href="#" onClick={this.getItems} />
          </PaginationItem>
        )}
        ...
        {this.props.next_page ? (
          ...
          <PaginationItem key="next">
            <PaginationLink next href="#" onClick={this.getItems} />
          </PaginationItem>
        )}
