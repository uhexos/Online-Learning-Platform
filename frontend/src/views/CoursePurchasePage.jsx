            ...
            <Row>
                ...
                <h4 className="my-0 text-center font-weight-normal">Pro</h4>
                  ...
                  <CardBody>
                    ...
                    <Button
                      ...
                      size="lg"
                      block
                      onClick={() => this.addToCart(this.state.course.id)}
                    >
                      Add to Cart
                    </Button>
                  </CardBody>
              ...
              <Col lg="9">
                  ...
                  <CardBody>
                    <CardTitle>
                      <CardTitle>
                        ...
                        <Helmet>
                          <title>Breakdown for {this.state.course.title}</title>
                        </Helmet>
                        <small className="text-muted">
                          ...
                          {this.state.course.owner.first_name +
                            ...
                            this.state.course.owner.username}
                        </small>
                      </CardTitle>
                      ...
                      <span className="text-warning">
                        <StarRatings
                          stars={this.state.course.rating.average}
                ...
                <Card className="my-4 shadow">
                  <CardBody className="">
                    <Comments
                      url={`http://localhost:8000/api/courses/${this.props.match.params.id}/`}
                      article_id={this.props.match.params.id}
                      article_title={this.state.course.title}
                    ></Comments>
                  </CardBody>
                </Card>
              </Col>
