...
from .views import CourseRatingDetailsView, CourseRatingCreateView, UserProfileView, CategoryList,CategoryDetail,CourseList,CourseDetail,LessonDetail,LessonList,CustomUserList,CustomUserDetail
